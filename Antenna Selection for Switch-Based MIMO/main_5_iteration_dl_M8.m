...
% load model_discrete_M8_1123.mat;
...
for i = 1:length(snrdB)
    ...
    % NN
    for j = 1:sim_times
        S7 = alg_nn(abs(sin(target_all(j)/180*pi)-1), (snr/30-0.5)*2, variables, D, M);
...
% save sim_data_M8_1124.mat
% load sim_data_M8_1124.mat
