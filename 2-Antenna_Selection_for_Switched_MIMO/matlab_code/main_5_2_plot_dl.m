...
hold on;semilogy(snrdB, MSE_sim(1,:), '--+r', 'Linewidth', linewidth, 'MarkerSize',markersize)
...
legend(legends(10:-1:1), 'ULA', 'PSL-C [\delta = 1]', 'PSL-C [\delta = 0.85]', 'PSL-C [\delta = 0.5]', 'Random', ...
'TRA-G [N_A=1, \Deltau=0.02]', 'TRA-G [N_A=1, \Deltau=0.1]', 'TRA-G [N_A=5, \Deltau=0.1]', 'TRA-DL [\Deltau=0.1]',...
'Best Case CRLB', 'Location', 'SouthWest', 'NumColumns',2);
